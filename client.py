...
def finishingBox():
    ...
    finishingBox = Label(gameWindow, text="Home", font=("Chalkboard SE", 32), width=7, height=3, borderwidth=0, bg="blue", fg="white")
    finishingBox.place(x=screen_width/2 - 113, y=screen_height/2 -150)
...
def handleWin():
    ...
    resetButton.place(c=screen_width / 2 - 80,y=screen_height - 220)            
